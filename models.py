...
class Customercustomerdemo(Base):
    ...
    CustomerID = Column(SmallInteger, primary_key=True, nullable=False)
    CustomerTypeID = Column(SmallInteger, primary_key=True, nullable=False)
...
class Customer(Base):
    ...
    CustomerID = Column(SmallInteger, primary_key=True)
...
class Order(Base):
    ...
    CustomerID = Column(SmallInteger)
...
class Region(Base):
    ...
    RegionDescription = Column(String(100), nullable=False)
...
class Territory(Base):
    ...
    TerritoryDescription = Column(String(100), nullable=False)
